...
{
	var songs:Array<CreditMetadata> = [];
	...
	override function create()
	{
		...
		for (i in 0...initSonglist.length)
		{
			...
			songs.push(new CreditMetadata(data[0]));
		}
		...
		for (i in 0...songs.length)
		{
			...
			var icon:HealthIcon = new HealthIcon(songs[i].songName);
	...
	override function update(elapsed:Float)
	{
		...
		scoreText.text = "PERSONAL BEST: " + songs[curSelected].songName;
