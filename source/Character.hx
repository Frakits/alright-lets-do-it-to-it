...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characters/gfasets', "shared");
				frames = tex;
			...
			case 'dad':
				...
				playAnim('idle');
			case 'sonic':
				// sonic ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/Sonic_Asets','shared');
				frames = tex;
				animation.addByPrefix('idle', 'sonic idle', 24);
				animation.addByPrefix('singUP', 'sonic up', 24);
				animation.addByPrefix('singRIGHT', 'sonic right', 24);
				animation.addByPrefix('singDOWN', 'sonic down', 24);
				animation.addByPrefix('singLEFT', 'sonic left', 24);

				addOffset('idle');
				addOffset("singUP", 5, 25);
				addOffset("singRIGHT", -50, -15);
			...
			case 'sonic-pissed':
				// sonic ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/sonic_2assets','shared');
				frames = tex;
				animation.addByPrefix('idle', 'sonic idle', 24);
				animation.addByPrefix('singUP', 'sonic up', 24);
				animation.addByPrefix('singRIGHT', 'sonic right', 24);
			...
			case 'dark-sonic':
				// sonic ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/sonic_dark','shared');
				frames = tex;
				animation.addByPrefix('idle', 'dsonic idle', 24);
				animation.addByPrefix('singUP', 'dsonic up', 24);
				animation.addByPrefix('singRIGHT', 'dsonic right', 24);
				animation.addByPrefix('singDOWN', 'dsonic down', 24);
				animation.addByPrefix('singLEFT', 'dsonic left', 24);
